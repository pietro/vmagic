...
/**
 * A case insensitive version of ANTLRFileStream.
 * CaseInsensitiveFileStream modifies the lookahead to be lower case only. The
 * case inside the token text is preserved for further usage.
 */
